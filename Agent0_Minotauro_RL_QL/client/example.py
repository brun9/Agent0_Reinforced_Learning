...
def reactive_example_2(c,res:int,qTable):
    ...
    if res != -1:
        ...
        for i in range(EPISODIOS):
            print("Episodio: ", i)
            # mover o agente para a casa inicial
        ...
        # apresentação das politicas no ambiente, depois que a Q Table é alterada ao longo dos váris episódios
        for casa in qTable:
            max_reward = 0
            max_reward_index = 0
